...
<form className="space-y-4" onSubmit={handleCheckVisa}>
  ...
  <div className="grid grid-cols-1 sm:grid-cols-[180px_auto] items-start sm:items-center gap-y-2 gap-x-4">
    ...
    <select className="px-3 py-1.5 text-sm border border-gray-300 rounded focus:outline-none focus:border-blue-500 bg-white w-full sm:w-60">
    ...
    <select className="px-3 py-1.5 text-sm border border-gray-300 rounded focus:outline-none focus:border-blue-500 bg-white w-full sm:w-32">
